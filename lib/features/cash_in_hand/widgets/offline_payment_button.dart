...
class OfflinePaymentButton extends StatelessWidget {
  ...
  const OfflinePaymentButton({super.key, required this.isSelected, required this.offlineMethodList, required this.onTap, required this.tooltipController, required this.cashInHandController});
        ...
        child: Column(children: [
          ...
          isSelected ? GridView.builder(
            ...
            itemBuilder: (context, index) {
              bool isSelected = cashInHandController.selectedOfflineBankIndex == index ;
              return InkWell(
                onTap: () => cashInHandController.selectOfflineBank(index),
                child: Container(
                  decoration: BoxDecoration(
