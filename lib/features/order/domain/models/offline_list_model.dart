...
class OfflineHistoryListModel {
  ...
  OfflineHistoryListModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    ...
    if (json['method_fields'] != null) {
      ...
      for (var json in methodFieldsJson) {
        methodFields?.add(MethodFieldsModel.fromJson(json));
      }
    }
...
class MethodFieldsModel {
  ...
  MethodFieldsModel({this.inputName, this.inputData});
